...
namespace gRPC_Movies {
  public static partial class MovieSvc
  {
    ...
    /// <summary>Base class for server-side implementations of MovieSvc</summary>
    [grpc::BindServiceMethod(typeof(MovieSvc), "BindService")]
    public abstract partial class MovieSvcBase
    {
      public virtual global::System.Threading.Tasks.Task<global::gRPC_Movies.MovieReply> GetMovies(global::gRPC_Movies.MovieRequest request, grpc::ServerCallContext context)
      {
    ...
    public static grpc::ServerServiceDefinition BindService(MovieSvcBase serviceImpl)
    {
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    public static void BindService(grpc::ServiceBinderBase serviceBinder, MovieSvcBase serviceImpl)
    {
      serviceBinder.AddMethod(__Method_GetMovies, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::gRPC_Movies.MovieRequest, global::gRPC_Movies.MovieReply>(serviceImpl.GetMovies));
    }
